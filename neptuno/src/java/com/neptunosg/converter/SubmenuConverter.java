...
@FacesConverter(value = "submenuConverter")
public class SubmenuConverter implements Converter {

    private SubmenuFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Submenu) {
            ...
            return getStringKey(o.getIdesub());
        } else {
    ...
    private SubmenuFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(SubmenuFacade.class).get();
